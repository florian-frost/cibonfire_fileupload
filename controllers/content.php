...
class content extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Fileupload.Content.View');
	...
	*/
	...
	{
		$this->auth->restrict('Fileupload.Content.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_fileupload())
			{
				...
				redirect(SITE_AREA .'/content/fileupload');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if ($this->input->post('save'))
		{
			$this->auth->restrict('Fileupload.Content.Edit');
		...
		{
			$this->auth->restrict('Fileupload.Content.Delete');
