...
class reports extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Fileupload.Reports.View');
	...
	*/
	...
	{
		$this->auth->restrict('Fileupload.Reports.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_fileupload())
			{
				...
				redirect(SITE_AREA .'/reports/fileupload');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if ($this->input->post('save'))
		{
			$this->auth->restrict('Fileupload.Reports.Edit');
		...
		{
			$this->auth->restrict('Fileupload.Reports.Delete');
