...
class developer extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Fileupload.Developer.View');
	...
	*/
	...
	{
		$this->auth->restrict('Fileupload.Developer.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_fileupload())
			{
				...
				redirect(SITE_AREA .'/developer/fileupload');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if ($this->input->post('save'))
		{
			$this->auth->restrict('Fileupload.Developer.Edit');
		...
		{
			$this->auth->restrict('Fileupload.Developer.Delete');
